                ...
                <div class="team-details team1-details">
                    ...
                    <div class="team-characters">
                        ${match.team1.characters.map((character, index) => `
                            <div class="character">
                                <div class="character-avatar" data-first-char="${character.firstChar}">
    ...
    avatars.forEach(avatar => {
        ...
        switch (firstChar) {
            ...
            case '红':
                ...
                break;
            case '园':
                backgroundColor = '#1abc9c'; // 青色
                break;
            case '杰':
                backgroundColor = '#34495e'; // 深蓝色
                break;
            case '盲':
                backgroundColor = '#7f8c8d'; // 灰色
                break;
            default:
                backgroundColor = '#95a5a6'; // 默认灰色
        }
